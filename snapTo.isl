; *** Inno Setup version 2.0.18+ English messages ***
;
...
;
; $Id: Default.isl,v 1.18 2001/12/22 05:43:21 jr Exp $
...
WelcomeLabel2=This will install [name/ver] on your computer. It's a small program that makes all top level windows snap to each other.
