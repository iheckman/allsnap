; *** Inno Setup version 3.0.4+ English messages ***
;
...
UninstalledMost=%1 uninstall complete.%n%nSome elements could not be removed. These can be removed manually. (make sure to close all open programs)
